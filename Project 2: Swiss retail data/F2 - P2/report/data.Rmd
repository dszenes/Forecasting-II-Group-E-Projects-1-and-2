...
<div class = "blue">
  ...
  The survey population is comprised of all enterprises active in retail tradewhich are domiciled in Switzerland. Large and medium enterprises are surveyed exhaustively, small enterprises are surveyed randomly. Large enterprises are surveyed each month, the others four times per year.The sample consistsof about 4000 enterprises. Micro enterprises are not included in the sample.
...
cons_raw_df <-
  read_csv(
    file = here::here("data/consumer_expectation.csv")
  ) #import the data
```
