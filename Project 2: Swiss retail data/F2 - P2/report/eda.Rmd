...
ts_new_cov <- ts_new_cov %>%
  mutate(crisis_dummy = month(year_month) == 4 & year(year_month) == 2020 )
...
reg_Comm_cov <- ts_new_cov %>%
  model(TSLM(information_communication_equipment ~ crisis_dummy + Hospital_Cases + trend() + season()))
...
reg_Cult_cov <- ts_new_cov %>%
  model(TSLM(cultural_recreation ~ crisis_dummy + Hospital_Cases + trend() + season()))
...
reg_Cloth_cov <- ts_new_cov %>%
  model(TSLM(clothing_footwear ~ crisis_dummy + Hospital_Cases + trend() + season()))
...
reg_Cloth_cov <- ts_new_cov %>%
  model(TSLM(clothing_footwear ~ Hospital_Cases + crisis_dummy + trend() + season()))
...
reg_Cult_cov <- ts_new_cov %>%
  model(TSLM(cultural_recreation ~  Hospital_Cases + crisis_dummy  + trend() + season()))
...
reg_Inter_cov <- ts_new_cov %>%
  model(TSLM(internet ~ crisis_dummy + Hospital_Cases +  trend() + season()))
